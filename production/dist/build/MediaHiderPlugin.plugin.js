...
/* harmony export */   "addHiddenMediaObject": () => (/* binding */ addHiddenMediaObject),
/* harmony export */   "createCacheEntry": () => (/* binding */ createCacheEntry),
/* harmony export */   "deleteHiddenMediaObject": () => (/* binding */ deleteHiddenMediaObject),
/* harmony export */   "getAllHiddenMediaObjects": () => (/* binding */ getAllHiddenMediaObjects),
/* harmony export */   "getHiddenMediaObject": () => (/* binding */ getHiddenMediaObject)
/* harmony export */ });
/* harmony import */ var _helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers/apiHelper */ "./helpers/apiHelper.ts");
/* harmony import */ var _helpers_makeLog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/makeLog */ "./helpers/makeLog.ts");
...
var _a = (0,_helpers_makeLog__WEBPACK_IMPORTED_MODULE_1__["default"])("projectService"), log = _a.log, debug = _a.debug;
var createCacheEntry = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0,_helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__.doRequest)("/media", {
                    body: payload,
                    method: "POST"
                })];
...
var getAllHiddenMediaObjects = function () { return __awaiter(void 0, void 0, void 0, function () {
    var HashedObjects;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                debug("getHiddenMedia(all)");
                return [4 /*yield*/, (0,_helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__.doRequest)("/hiddenMedia", {})];
            case 1:
...
var getHiddenMediaObject = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var HashedObject;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                debug("getHiddenMedia(".concat(url, ")"));
                return [4 /*yield*/, (0,_helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__.doRequest)("/hiddenMedia/".concat(url), {})];
            case 1:
...
var addHiddenMediaObject = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                debug("addHiddenMediaObject(".concat(url, ")"));
                return [4 /*yield*/, (0,_helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__.doRequest)("/hiddenMedia/".concat(url), {
                        body: url,
                        method: "POST"
                    })];
...
var deleteHiddenMediaObject = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                debug("DeleteHashedObject(".concat(url, ")"));
                return [4 /*yield*/, (0,_helpers_apiHelper__WEBPACK_IMPORTED_MODULE_0__.doRequest)("/hiddenmedia/".concat(url), {
                        body: url,
                        method: "Delete"
                    })];
 ...
 */
var doRequest = function (url, params) { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch(API_URL + url, params)];
            case 1:
                response = _a.sent();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeLog);
        ...
        } is missing. Please click Download Now to install it.`,
        {
            ...
            onConfirm: () => {
                (__webpack_require__(/*! request */ "?470d").get)(
                    ...
                    async (err, resp, body) => {
                        if (err)
                            return (__webpack_require__(/*! electron */ "./node_modules/electron/index.js").shell.openExternal)(
                        ...
                        if (resp.statusCode === 302) {
                            (__webpack_require__(/*! request */ "?470d").get)(
                                ...
                                async (error, response, content) => {
                                    ...
                                    await new Promise((r) =>
                                        (__webpack_require__(/*! fs */ "?569f").writeFile)(
                                            (__webpack_require__(/*! path */ "?3f59").join)(
